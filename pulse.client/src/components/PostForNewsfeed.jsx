    ...
    useEffect(() => {
        ...
        const fetchPosts = async () => {
            try {
                ...
                const response = await fetch(`https://localhost:7199/api/Post/FriendsPosts/${userId}`);
                if (!response.ok) {
    ...
    return (
        <>
            {posts.length > 0 ? (
                ...
                <p className="mx-auto"><em>You do not follow any user. Follow to see posts.</em></p>
            ) : (
...
export default PostForNewsfeed;
