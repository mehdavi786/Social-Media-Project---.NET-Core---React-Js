    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserChats", x => new { x.UserId, x.ChatMessageId });
                    table.ForeignKey(
                        name: "FK_UserChats_Chat_ChatMessageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserChats_ChatMessageId",
                table: "UserChats",
                column: "ChatMessageId");

            migrationBuilder.CreateIndex(
                name: "IX_UserChats_UserId_ChatMessageId",
                table: "UserChats",
